...
public:
	SkillObstacle() : m_obstacleStartPosition(0.0f, 0.0f), m_obstacleCurrentPosition(0.0f, 0.0f), m_obstacleDirection(0.0f, 0.0f), m_obstacleSpeed(300.0f), m_obstacleEffect(NORMAL){};
